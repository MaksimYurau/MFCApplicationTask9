...
// Lab9CheckBox.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CLab9CheckBoxApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CLab9CheckBoxApp

CLab9CheckBoxApp::CLab9CheckBoxApp()
{
...
// Единственный объект CLab9CheckBoxApp

CLab9CheckBoxApp theApp;


// Инициализация CLab9CheckBoxApp

BOOL CLab9CheckBoxApp::InitInstance()
{
